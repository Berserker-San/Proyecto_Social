...
const FullRegistration: React.FC<FullRegistrationProps> = ({ context, onBack }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    docType: 'Tarjeta Identidad', docId: '',
    firstName: '', lastName: '',
    sex: '', genderIdentity: '',
    birthDate: '', birthPlace: '',
    nationality: 'Colombiana',
    phone: '', email: '', linkage: '',
    address: '', neighborhood: '', city: '', commune: '',
    stratum: '',
    occupation: '', educationLevel: '', grade: '', school: '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Full registration submit:', formData);
  };
        ...
        <div className="wizard-card">
          ...
          <div className="wizard-upload-list">
            {[
              ...
              <label key={doc.name} className="wizard-upload-zone">
                <input type="file" name={doc.name} onChange={handleChange} accept=".pdf,.jpg,.jpeg,.png" hidden />
                <div className="wizard-upload-icon">{doc.icon}</div>
                <strong>{doc.label}</strong>
                <span>{(formData as any)[doc.name]?.name ?? 'Clic para cargar'}</span>
              </label>
            ))}
          </div>
        ...
        <div className="full-form">
          {step === 'basic' && (
            <>
              ...
              <div className="form-grid-2">
                ...
                <div><label className="form-label">LUGAR DE NACIMIENTO</label><input name="birthPlace" value={formData.birthPlace} onChange={handleChange} className="form-input" /></div>
              </div>
              <div className="form-grid-2">
                <div><label className="form-label">NACIONALIDAD</label><input name="nationality" value={formData.nationality} onChange={handleChange} className="form-input" /></div>
                <div>
          ...
          {step === 'residence' && (
            <>
              ...
              <div className="form-grid-2">
                <div><label className="form-label">CIUDAD</label><input name="city" value={formData.city} onChange={handleChange} className="form-input" /></div>
              ...
              <div className="form-grid-2">
                <div><label className="form-label">COMUNA</label><input name="commune" value={formData.commune} onChange={handleChange} className="form-input" placeholder="Ej. Comuna 13" /></div>
                <div>
              ...
              <div className="form-group"><label className="form-label">INSTITUCIÓN</label><input name="school" value={formData.school} onChange={handleChange} className="form-input" placeholder="Nombre del colegio / universidad..." /></div>
              <div className="form-grid-2">
          ...
          {step === 'health' && (
            <>
              <div className="form-grid-2">
                <div><label className="form-label">EPS / ASEGURADORA</label><input name="eps" value={formData.eps} onChange={handleChange} className="form-input" placeholder="Ej. Sura, Compensar..." /></div>
